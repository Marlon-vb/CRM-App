...
- **Testing debt:** zero committed tests/CI; the invariants that keep
  breaking (M1, M3) live only in comments. The harnesses already exist in
  session scratch — commit them as `npm test` + GitHub Actions.

---

## Recommended shipping order

**Wave 1 — stop the lying (1–2 sessions).**
...
**Wave 2 — make triage safe (1 session).**
...
**Wave 3 — correctness under sync (1 session).**
